                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                        				    ...
                        				    <hr>
                        					<form method="POST" action="<?=base_url()?>admin/edit_new_client_request/<?=$datas[0]['c_id']?>">                                    
	                                            ...
	                                            <div class="form-group col-md-6">
	                                                ...
	                                                <div class="col-md-6">
	                                                    <input type="text" class="form-control" name="username" value="<?=$datas[0]['username']?>" placeholder="Email Address" required>
	                                                </div>
	                                            </div> 
	                                            <div class="form-group col-md-6">
	                                            ...
	                                            <div class="form-group col-md-6">
	                                             ...
	                                             <div class="form-group col-md-6">
	                                                ...
	                                                <div class="col-md-6">
	                                                    <input type="text" class="form-control" name="bank_acc_num" value="<?=$datas[0]['bank_acc_num']?>" placeholder="Bank Account Number:">
	                                                </div>
	                                            </div>
	                                             <div class="form-group col-md-6">
