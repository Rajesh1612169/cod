                    ...
                    <div class="container">
                        <div class="row">
                           <div class="card-box table-responsive">
                            ...
                            <div class="col-md-12">
                                <form action="<?=base_url()?>admin/booking" method="POST" autocomplete="off">
...
<?php
    ...
    if($this->session->flashdata('changed')){
        echo "<script>$.Notification.notify('success','top right', 'Success', 'Consignment status chnaged Successfully.')</script>";
    }
    ?>