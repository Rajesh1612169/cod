                        		   ...
                        		   <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="pull-left m-t-30">
                                                    <address>To:<br>
                                                      <strong><?=$invoice[0]['company_name']?> - <?=$invoice[0]['client_name']?></strong><br>
                                                      <?=$invoice[0]['address']?><br>
                                                      Phone: <?=$invoice[0]['number']?><br>
                                                      CNIC: <?=$invoice[0]['cnic']?><br>
                                                      </address>
                                                </div>
                                        ...
                                        <div class="hidden-print">
                                            <div class="pull-right">
                                                <a href="javascript:window.print()" class="btn btn-inverse waves-effect waves-light" style='background:#f6c72c'><i class="fa fa-print"></i> Print</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
